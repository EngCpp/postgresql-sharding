...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
  ...
  COMMIT;
   ...
   CREATE FOREIGN TABLE IF NOT EXISTS customers_2021 PARTITION OF customers FOR VALUES FROM('2021-01-01')TO('2021-12-31') SERVER pg_shard_1;
   CREATE FOREIGN TABLE IF NOT EXISTS customers_2022 PARTITION OF customers FOR VALUES FROM('2022-01-01')TO('2022-12-31') SERVER pg_shard_2;
   CREATE FOREIGN TABLE IF NOT EXISTS customers_2023 PARTITION OF customers FOR VALUES FROM('2023-01-01')TO('2023-12-31') SERVER pg_shard_3;    
EOSQL
